...
{  
    Properties   
    {  
        _MainTex("Base(RGB)", 2D) = "white" {}  //主颜色
        _TimeX("Time", Range(0.0, 1.0)) = 1.0  //没用到，
        _Distortion("_Distortion", Range(0.0, 1.0)) = 0.3   //没用到，变形，失真，扭曲
        _ScreenResolution("_ScreenResolution", Vector) = (0.0, 0.0, 0.0, 0.0)  //屏幕分辨率
        _Radius("_Radius", Range(0.0, 1000.0)) = 700   //半径
        _Factor("_Factor", Range(0.0, 1000.0)) = 200  //因素，因数
    }  
    SubShader   
    {  
        Pass   
